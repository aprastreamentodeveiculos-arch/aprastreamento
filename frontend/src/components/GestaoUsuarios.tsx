          ...
          <div className="modal-content" style={{ maxWidth: '500px' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <input type="password" value={senha} onChange={e => setSenha(e.target.value)} required={!editUser} className="input" />
              </div>
              ...
              {editUser && (
                <div className="form-group" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <label htmlFor="ativo" style={{ margin: 0 }}>Usuário Ativo (Pode fazer login)</label>
                </div>
              )}
